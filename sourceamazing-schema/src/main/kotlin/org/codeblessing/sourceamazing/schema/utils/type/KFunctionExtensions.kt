...
@Suppress("UNUSED")
fun KFunction<*>.receiverParameter() = parameters.firstOrNull { it.kind == KParameter.Kind.EXTENSION_RECEIVER }

@Suppress("UNUSED")
fun KFunction<*>.instanceParameter() = parameters.firstOrNull { it.kind == KParameter.Kind.INSTANCE }
...
val KFunction<*>.isPrivateConstructor: Boolean
    get() = this.javaConstructor?.modifiers?.let { modifiers -> Modifier.isPrivate(modifiers) } ?: false
