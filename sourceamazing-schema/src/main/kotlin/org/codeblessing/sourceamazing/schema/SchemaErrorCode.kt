...
enum class SchemaErrorCode(override val messageFormat: String): ErrorCode {
    ...
    MUST_HAVE_ANNOTATION("%s must have an annotation of type '%s'."),
    MUST_HAVE_ONE_OF_THE_FOLLOWING_ANNOTATIONS("%s must have must have one of the annotations %s."),
    NOT_REPEATABLE_ANNOTATION("%s can not have more than one of the annotations %s."),
    NOT_MORE_THAN_NUMBER_OF_ANNOTATIONS("%s can not have more than %s annotation of type %s."),
