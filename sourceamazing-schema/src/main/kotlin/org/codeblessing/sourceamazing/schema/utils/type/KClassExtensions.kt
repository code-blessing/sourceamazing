...
inline fun <reified T : Annotation> KClass<*>.getAnnotationIncludingSuperclasses(): T =
    getAnnotationIncludingSuperclasses(T::class)

fun <T : Annotation> KClass<*>.getAnnotationIncludingSuperclasses(annotationClass: KClass<T>): T =
    findAnnotationIncludingSuperclasses(annotationClass, this).first()
