...
enum class DataCollectionErrorCode(override val messageFormat: String) : ErrorCode {
    ...
    MISSING_REFERENCED_CONCEPT_FACET_VALUE(
        "Facet '%s' of concept identifier '%s' in concept '%s' points to a reference that was not found. No concept with concept id '%s'. Must be one of these concepts: %s. \n%s"
    ),
    ...
    UNKNOWN_FACET(
        "Unknown facet name '%s' found for concept identifier '%s' in concept '%s'. Known facets are: %s. \n%s"
    ),
    WRONG_FACET_TYPE(
        "Facet '%s' for concept identifier '%s' in concept '%s' has a wrong type. A facet of type '%s' can not have a value of type '%s' (%s).\n%s"
    ),
    WRONG_FACET_ENUM_TYPE(
        "Facet '%s' for concept identifier '%s' in concept '%s' has a wrong type. A facet value must be one of %s but was %s (%s).\n%s"
    ),
    MINIMUM_CARDINALITY_ERROR(
        "Facet '%s' for concept identifier '%s' in concept '%s' has a wrong cardinality. The facet must have in minimum %s entries but had %s.\n%s"
    ),
    MAXIMUM_CARDINALITY_ERROR(
        "Facet '%s' for concept identifier '%s' in concept '%s' has a wrong cardinality. The facet must not have more than %s entries but had %s.\n%s"
    ),
}
