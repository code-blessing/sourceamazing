...
interface ErrorCode {
    ...
    fun format(vararg messageArguments: Any): String {
        ...
        if (numberOfPlaceholders != messageArguments.size) {
            throw ErrorCodeFormattingException(
    ...
    fun withFormattedMessage(vararg messageArguments: Any): ErrorCodeWithMessage {
        return ErrorCodeWithMessage(this, this.format(*messageArguments))
    }
}
