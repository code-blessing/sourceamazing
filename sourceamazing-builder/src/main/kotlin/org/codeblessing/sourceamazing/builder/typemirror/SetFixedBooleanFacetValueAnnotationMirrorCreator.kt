...
class SetFixedBooleanFacetValueAnnotationMirrorCreator: AnnotationMirrorCreator {
    override fun annotationClass(): KClass<out Annotation> = SetFixedBooleanFacetValue::class

    override fun createAnnotationMirror(
        annotation: Annotation,
        classMirrorCreatorCallable: ClassMirrorCreatorCallable
    ): AnnotationMirror {
        val setFacetValueAnnotation = annotation as SetFixedBooleanFacetValue
        return SetFixedBooleanFacetValueAnnotationMirror(
