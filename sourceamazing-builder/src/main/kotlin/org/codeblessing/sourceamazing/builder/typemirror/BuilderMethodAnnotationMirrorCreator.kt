...
class BuilderMethodAnnotationMirrorCreator : AnnotationMirrorCreator {
    override fun annotationClass(): KClass<out Annotation> = BuilderMethod::class

    override fun createAnnotationMirror(
        annotation: Annotation,
        classMirrorCreatorCallable: ClassMirrorCreatorCallable
    ): AnnotationMirror {
        return BuilderMethodAnnotationMirror()
    }
}