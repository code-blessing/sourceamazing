...
class SetFixedIntFacetValueAnnotationMirrorCreator: AnnotationMirrorCreator {
    override fun annotationClass(): KClass<out Annotation> = SetFixedIntFacetValue::class

    override fun createAnnotationMirror(
        annotation: Annotation,
        classMirrorCreatorCallable: ClassMirrorCreatorCallable
    ): AnnotationMirror {
        val setFacetValueAnnotation = annotation as SetFixedIntFacetValue
        return SetFixedIntFacetValueAnnotationMirror(
