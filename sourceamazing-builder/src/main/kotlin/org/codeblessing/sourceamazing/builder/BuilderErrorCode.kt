...
enum class BuilderErrorCode(override val messageFormat: String): ErrorCode {
    ...
    DUPLICATE_ALIAS_IN_EXPECTED_ALIAS_FROM_SUPERIOR_BUILDER_ANNOTATION("The alias '%s' was listed multiple times with the ${ExpectedAliasFromSuperiorBuilder::class.annotationText()}. %s"),
