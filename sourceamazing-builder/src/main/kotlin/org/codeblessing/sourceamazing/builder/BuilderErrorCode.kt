...
enum class BuilderErrorCode(override val messageFormat: String): ErrorCode {
    ...
    BUILDER_PARAM_INJECTION_CANNOT_HAVE_PARAMS("An injected builder (parameter with ${InjectBuilder::class.annotationText()}) must have as sole parameter a receiver parameter (extension function) type. Its declaration must be \'<Builder>.() -> Unit\'."),
