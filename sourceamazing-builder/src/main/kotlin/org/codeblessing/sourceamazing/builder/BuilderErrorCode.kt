...
enum class BuilderErrorCode(override val messageFormat: String): ErrorCode {
    ...
    UNKNOWN_CONCEPT("The alias '%s' introduced with the annotation ${NewConcept::class.annotationText()} points to a unknown concept '%s'. You must register the concept on the schema by declaring a property referencing this concept. %s"),
