...
enum class BuilderErrorCode(override val messageFormat: String): ErrorCode {
    ...
    ALIAS_IS_ALREADY_USED("The alias '%s' introduced with the annotation ${NewConcept::class.annotationText()} for concept '%s' is already used. All already used alias names are %s. Choose another alias name."),
    ALIAS_NO_AVAILABLE_IN_EXPECTED_ALIAS_FROM_SUPERIOR_BUILDER_ANNOTATION("The alias '%s' was expected by the annotation ${ExpectedAliasFromSuperiorBuilder::class.annotationText()} but was not provided by the superior builder."),
    DUPLICATE_ALIAS_IN_EXPECTED_ALIAS_FROM_SUPERIOR_BUILDER_ANNOTATION("The alias '%s' was listed multiple times with the ${ExpectedAliasFromSuperiorBuilder::class.annotationText()} annotation."),
    UNKNOWN_CONCEPT("The alias '%s' introduced with the annotation ${NewConcept::class.annotationText()} points to a unknown concept '%s'. You must register the concept on the schema by declaring a property referencing this concept."),
    ...
    DUPLICATE_SET_RANDOM_CONCEPT_IDENTIFIER_VALUE_USAGE("The concept behind alias '%s' is initialized multiple times with the annotation ${SetRandomConceptIdentifierValue::class.annotationText()}. Remove the duplicate initializations or choose another alias name."),
    DUPLICATE_SET_CONCEPT_IDENTIFIER_VALUE_USAGE("The concept behind alias '%s' is initialized multiple times with the annotation ${SetConceptIdentifierValue::class.annotationText()}. Remove the duplicate initializations or choose another alias name."),
    DUPLICATE_CONCEPT_IDENTIFIER_INITIALIZATION("The concept behind alias '%s' is initialized multiple times with the annotation ${SetConceptIdentifierValue::class.annotationText()} and ${SetRandomConceptIdentifierValue::class.annotationText()}. Do only use one of the annotation per alias."),
    UNKNOWN_ALIAS("The alias '%s' used with the annotation %s is unknown. Choose a known alias name (one of %s) or declare an alias with ${NewConcept::class.annotationText()}."),
