...
class BuilderMethodApiParameterTypesTest {
    ...
    @Test
    fun `test string facet parameter with collection type instead of string should throw an exception`() {
        assertThrows(BuilderMethodSyntaxException::class.java) {
            SchemaApi.withSchema(schemaDefinitionClass = SchemaWithConceptWithTextFacet::class) { schemaContext ->
    ...
    @Test
    fun `test reference facet parameter with other type than a ConceptId should throw an exception`() {
        assertThrows(BuilderMethodSyntaxException::class.java) {
            SchemaApi.withSchema(schemaDefinitionClass = SchemaWithConceptWithTextFacet::class) { schemaContext ->
