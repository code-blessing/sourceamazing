...
fun assertBuilderSyntaxException(expectedBuilderErrorCode: BuilderErrorCode, executable: () -> Unit) {
    assertExceptionWithErrorCode(BuilderSyntaxException::class, expectedBuilderErrorCode, executable)
}
